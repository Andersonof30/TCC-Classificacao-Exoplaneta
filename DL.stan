...
for(i in 1:N){
  ...
  p[i] = 0.5+0.5*signnum(beta0 + beta1*X1[i] + beta2*X2[i] +      
  beta3*X3[i] + beta4*X4[i] + beta5*X5[i] + 
  beta6*X6[i])*(
    1- 0.5*(2+abs(beta0 + beta1*X1[i] + beta2*X2[i] +      
    beta3*X3[i] + beta4*X4[i] + beta5*X5[i] +     
    beta6*X6[i])
    )*exp(-abs(beta0 + beta1*X1[i] + beta2*X2[i] +      
    beta3*X3[i] + beta4*X4[i] + beta5*X5[i] +     
    beta6*X6[i]))); 
}
}
